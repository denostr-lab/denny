...
export class RoomState extends TypedEventEmitter<EmittedEvents, EventHandlerMap> {
  ...
  public setStateEvents(
    ...
    markerFoundOptions?: IMarkerFoundOptions
  ): void {
    this.updateModifiedTime();
  ...
  public async processBeaconEvents(
    events: MatrixEvent[],
    ...
    const beaconByEventIdDict = [...this.beacons.values()].reduce<Record<string, Beacon>>(
      (dict, beacon) => {
