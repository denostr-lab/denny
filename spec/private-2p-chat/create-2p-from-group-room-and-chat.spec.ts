...
import { login, enterPublicRoom, createBrowserAndPage, searchRoomMember } from "../utils";
...
describe("test two person enter public room and chat", () => {
    ...
    beforeAll(async () => {
        ...
        await Promise.all([searchRoomMember(user1.page, user2.pubkey), searchRoomMember(user2.page, user1.pubkey)]);
