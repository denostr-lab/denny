...
describe("测试公共功能", () => {
    ...
    it(
        ...
        async () => {
            ...
            await page.$$eval(
                ...
                (el, name) => {
                    el.map((i) => {
                        if (i.querySelectorAll("p")[0].innerText === name) {
                            i.click();
                        }
                    });
                },
    ...
    it(
        ...
        async () => {
            ...
            const name = `测试创建的公开房间的新房间名${new Date()}`;
    ...
    it(
        ...
        async () => {
            ...
            await page.$eval(".ReactModal__Content--after-open button", (el) => {
                el.click();
            });
            await page.waitForTimeout(4 * 1000);
            ...
            // 查找是否有创建的房间
            await page.waitForSelector(".room-selector__content");
            const resultName = await page.$$eval(".room-selector__content", (el) => {
                el.map((i) => {
                    if (i.querySelectorAll("p")[0].innerText === name) {
                        return name;
                    }
